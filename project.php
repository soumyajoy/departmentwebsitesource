...
<div class="container">
    ...
    <form class="form-horizontal" method="post" action="process1.php" enctype="multipart/form-data">
        <fieldset>
            <legend>PROJECT DETAILS<i class="fa fa-pencil pull-right"></i></legend>
                        <div class="form-group">
                                <label class="sr-only" for="form-first-name"></label>
                                Student Name<input type="varchar" style="background:#F5F19C" name="sname" id="name1"  class="form-first-name form-control" id="form-first-name"><label id="lname1"></label>
                            </div>
                                <div class="form-group">
                                <label class="sr-only" for="form-first-name"></label>
                                Project Name<input type="varchar" style="background:#F5F19C" name="pname" id="name1"  class="form-first-name form-control" id="form-first-name"><label id="lname1"></label>
                            </div>
                            
                            <div class="form-group">
                                <label class="sr-only" for="form-first-name"></label>
                                Description<input type="varchar" style="background:#F5F19C" name="pname" id="name1"  class="form-first-name form-control" id="form-first-name"><label id="lname1"></label>
                            </div>
                            
                                <div class="form-group">
                                <label class="sr-only" for="form-first-name"></label>
                                Year of Admission<input type="varchar" style="background:#F5F19C"name="date" id="name1"  class="form-first-name form-control" id="form-first-name"><label id="lname1"></label>
                            </div>
                                <div class="form-group">
