	...
	<section class="aboutus" id="aboutus">
		<div class="container">
			<div class="heading text-center">				
				<h2>Master of cmputer application</h2>				
			</div>			
			<div class="row">
				<div class="col-md-6">
					<div class="papers text-center">
						<img src="../upload/<?php echo $r[12];?>" alt=""><br/><!---image stored at 12 position registration table-->
...
<!--education-->
	...
	<section class="feedback" id="experience">
		<div class="container">
			<div class="heading">
				<h2 class=" label-info">Experience</h2>
