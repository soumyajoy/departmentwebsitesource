...
<div class="container">
    <div class="col-sm-8 col-sm-push-2">
         <form class="form-horizontal" method="post" action="Add_cat_Action.php" enctype="multipart/form-data">
                        <fieldset>
                            <legend>Category Details<i class="fa fa-pencil pull-right"></i></legend>
                            
        Enter the category
        <input type="text" name="txtcat" id="txtcat" class="form-control">
        
          <label for="txtcat"></label>
